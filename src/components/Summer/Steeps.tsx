  ...
  return (
    <div className="size-full relative overflow-hidden bg-gradient-to-br from-orange-50 to-yellow-100">
      <Helmet>
        ...
        <meta name="description" content="Conquer challenging descents with proper technique and control." />
      </Helmet>
      ...
      <div className="absolute inset-0 pt-32 pb-24 overflow-y-auto">
        <div className="max-w-6xl mx-auto px-8">
          <h2 className="text-4xl font-bold text-orange-600 mb-6">
            Conquer Steep Terrain
          </h2>
          <p className="text-xl text-gray-700 mb-8">
            Master challenging descents with proper technique and control.
          </p>
          <div className="space-y-4 text-lg text-gray-700">
            <p>
              Steep descents demand respect, technique, and commitment. Getting
              your weight back and low is crucial.
            </p>
            <p>
              Practice feathering your brakes, looking ahead to plan your line,
              and staying relaxed to absorb bumps and maintain traction.
            </p>
          </div>
        </div>
      </div>
