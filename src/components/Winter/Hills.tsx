...
export default function Hills() {
  return (
    <div className="size-full relative overflow-hidden bg-gradient-to-br from-orange-50 to-yellow-100">
      <Helmet>
        <title>Hills | Cross-Country Skiing | Robert Pevny Coaching</title>
        <meta name="description" content="Learn uphill and downhill techniques for efficient climbs and safe descents on cross-country skis." />
      </Helmet>
      <header className="absolute top-0 left-0 right-0 z-20 p-8 bg-gradient-to-b from-white/60 to-transparent backdrop-blur-sm">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-5xl text-gray-800 font-nunito">Hills</h1>
        </div>
      </header>
