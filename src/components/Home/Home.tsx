    ...
    <div className="min-h-screen w-full relative overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800">
      ...
      <div className="absolute inset-0 flex flex-col">
        <Link to="/summer" className="flex-1 relative overflow-hidden group">
          <div
            className="absolute inset-0 bg-cover transition-all duration-500 group-hover:brightness-110 group-hover:scale-[1.02]"
            style={{
          ...
          <div className="absolute bottom-6 left-6 sm:left-10">
            <h2 className="text-3xl sm:text-5xl font-bold text-white drop-shadow-lg">Summer</h2>
            <p className="text-base sm:text-xl text-white/90 mt-1 drop-shadow-md">Adventure awaits</p>
          </div>
        </Link>
        ...
        <Link to="/winter" className="flex-1 relative overflow-hidden group">
          ...
          <div className="absolute top-6 right-6 sm:right-10 text-right">
            <h2 className="text-3xl sm:text-5xl font-bold text-white drop-shadow-lg">Winter</h2>
            <p className="text-base sm:text-xl text-white/90 mt-1 drop-shadow-md">Embrace the cold</p>
          </div>
        </Link>
      </div>
